...
float k = 1.8 / 16;                      // Definir la resolución del motor (1.8 degrees / 16 debido al encendido de los microsteps 1 y 2 del driver)
float angularVelocity = gear * 180 / k; // Definir una velocidad angular constante
...
void setup() 
{
  ...
  stepper.setMaxSpeed(1000);            // 1000 steps / sec MAX == 1800 deg / sec motor's speed == 600 deg / sec table's speed
